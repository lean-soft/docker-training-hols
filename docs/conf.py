...
project = u'Docker 培训动手实验'
AUTHORS = u"LeiXu@lean-soft.cn"
...
man_pages = [
    ('index', 'docker-training-labs', u'DOCKER 培训动手实验文档',
     [AUTHORS], 1)
]
...
texinfo_documents = [
  ('index', 'docker-training-labs', u'DOCKER 培训动手实验文档',
   AUTHORS, 'docker-training-labs', 'One line description of project.',
   'Miscellaneous'),
]
